...
// test classin da obje olusturmadigimiz sadece depo olarak kullancagimiz  icin abstract yaptik
//Bu class i kullanabilmek icin extends etmemiz lazim classlara
public abstract class TestBase {
    ...
    */
    ...
    public void tearDown() throws Exception {
        ...
        extentReports.flush(); // flush ile raporu sonlandirdik
        //driver.quit();
    }
    ...
    public void extentReport(String browser,String reportName){
        ...
        extentReports.setSystemInfo("Tester","Nuri");
