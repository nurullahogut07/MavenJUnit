...
public class C03_BeforeClassAfterClass {
    static   WebDriver driver ;
     // IKinci test calismaz cunku BeforeClass classlardan once bir kere  calisir , test01 calisti , test02 calismadi
    // Test02 calismasi icin her methoddan once calisacak olan before methodunun icine koymamiz gerekli
