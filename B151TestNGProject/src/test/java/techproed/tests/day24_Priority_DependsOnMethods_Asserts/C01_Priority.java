  ...
  Priority kullanmadığımız methodda priority değerini 0(sıfır) olarak kabul eder.
    */
    ...
    public void youtubeTest() {
        driver.get("https://youtube.com"); // youtube once calissin (default deger 0 sifir oldugu icin ilk bu calisir )
    }
    @Test(priority = 2)
    public void facebookTest() {
        driver.get("https://facebook.com"); // son olarak face calissin
    }
